...
{   
    ...
    for(int i=0; i< WORDS; i++)
        while(s[start]== dictionary.words[i].letters[start])
        {
            start++ ;
            if(s[start]== '\0' && dictionary.words[i].letters[start]== '\0'&& dictionary.words[i].found== false )
                {
                    dictionary.words[i].found= true ;
                    return true ;
                }
            else if(s[start]== '\0' && dictionary.words[i].letters[start] != '\0')
                {
                    dictionary.words[i].found= false ;   
                    return false ;
                }
        }
    return false;
